$(function () {
    ...
    .then(data => {
        ...
        if (data.status === 'error') {
            ticketContainer.innerHTML = '<div class="notification is-danger">Bir hata oluştu: ' + (data.message || 'Bilinmeyen hata') + '</div>';
        }
                                        ...
                                        <div class="columns is-vcentered">
                                            ...
                                            <div class="column is-2">
                                                <div class="price-info">
                                                    <p class="price has-text-dark is-size-4"><strong>${ticket.total_price}₺</strong></p>
...
function cancelTicket(ticketId) {
    ...
    .then(data => {
        if (data.success) {
            ...
            alert('Bilet iptal edilemedi: ' + (data.message || 'Bilinmeyen hata'));
        }
    })
    .catch(error => {
